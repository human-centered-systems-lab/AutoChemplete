...
from utils import load_reversed_token_map, str2bool, convert_smiles
...
def one_input():
        ...
        for img in imgs:
            ...
            try:
                ...
                print(
                    "Predicted SMILES"
                    + smiles
                    + " couldn't be redrawn as chemical structure."
                )
    ...
    if config.work_type == "multi_model_pred":
        ...
        with open(
            "./model/prediction_models.yaml"
        ) as f:
            p_configs = yaml.safe_load(f)
        ...
        def _decode(models, _input):
            ...
            for model in models:
                ...
                predictions = model._decoder(
                    encoded_imgs, decode_lengths=model._decode_length, mode="generation"
                )
