...
def description(elements_num, bonds_num, atoms_num, weights):
    ...
    weights = weights
    des = "This chemical structure contains {1} atoms and {2} bonds between them. There are {3} elements {4}, the corresponding number for each element is {5}. Its weights is {0} in total.".format(
        weights, atoms_num, bonds_num, elem_num, key_string, values_string
    )
    return des
